<template>
  <SwitchGroup as="div" class="flex items-center justify-between">
    <span class="flex flex-grow flex-col">
      <SwitchLabel as="span" class="text-sm font-medium text-gray-500" passive>{{props.label}}</SwitchLabel>
      <SwitchDescription as="span" class="text-sm text-gray-400">{{props.description}}</SwitchDescription>
    </span>
